    ...
    return (
        <div className="bg-[#F5F5F5]">
            ...
            <div className="container mx-auto flex justify-between px-2 py-2">
                {/* Image Section */}
                <div id="1" className="hover:transfomr hover:scale-125 duration-200 ease-in-out">
            ...
            <div className={`${isMenuOpen ? "block" : "hidden"} md:hidden flex flex-col my-5 font-base `}>
                ...
                <Link href="#contact" className=" px-3 py-2 font-normal text-sm hover:underline underline-offset-4">Sign In</Link>
            </div>
            {/* Header */}
            <header className="bg-white">
                <div className="container mx-auto bg-white flex justify-between items-center">
                    ...
                    <div>
                        <Link href="/">
                        <Image src={"/header/Logo.png"} alt="logo" width={58} height={20} className="hover:transfomr hover:scale-110 duration-200 ease-in-out ml-2 w-7 h-3 md:w-[58px] md:h-5"></Image>
                        </Link>
                    </div>
                    {/* Headings */}
                    <div className="hidden lg:flex space-x-8 font-medium text-sm leading-6">
                        <p className="hover:underline underline-offset-2 cursor-pointer">New & Featured</p>
                        <p className="hover:underline underline-offset-2 cursor-pointer">Men</p>
                        <p className="hover:underline underline-offset-2 cursor-pointer">Women</p>
                        <p className="hover:underline underline-offset-2 cursor-pointer">Kids</p>
                        <p className="hover:underline underline-offset-2 cursor-pointer">Sale</p>
                        <p className="hover:underline underline-offset-2 cursor-pointer">SNKRS</p>
                    </div>
                    {/* Searchbar */}
                    <div className="flex items-center gap-2 ">
                        ...
                        <input type="text" placeholder="Search" className="w-[84px] h-[18px] bg-[#F5F5F5] "  />
                        </div>
                        {/* Icons */}
                        <div id="3"
